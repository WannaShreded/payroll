...
class SalarySlip extends StatelessWidget {
  ...
  const SalarySlip({super.key, required this.payroll, required this.employee});
              ...
              Expanded(
                child: ElevatedButton.icon(
                  onPressed: () async {
                        ...
                        build: (context) => [
                          ...
                          pw.Row(
                            mainAxisAlignment:
                                pw.MainAxisAlignment.spaceBetween,
                            children: [
                              pw.Text('Total Hari Hadir'),
                              pw.Text('${payroll.totalDaysPresent} Hari'),
                            ],
                          ),
                          pw.Row(
                            mainAxisAlignment:
                    ...
                    final filename =
                        'slip_gaji_${employee.nik ?? 'unknown'}_${payroll.month}_${payroll.year}.pdf';
